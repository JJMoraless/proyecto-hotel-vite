...
document.getElementById("selectedSearch").addEventListener("change",function () {
...
document.getElementById("btnFiltroReservas").addEventListener("click",function () {
  const param = document.getElementById("selectedSearch").value;
  //filtro
  if (param === "Documento") {
    ...
    const entrada = (document.getElementById("searchEntryDate").value)+"T00:00:00.000Z";
