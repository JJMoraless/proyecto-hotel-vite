...
const getUsers = async () => {
  try {
    ...
    for (const users of usersList) {
      ...
      row.innerHTML = `
            <td class="col-xs-2">${users.id || ""}</td>
            <td class="col-xs-2">${users.document || ""}</td>
            <td class="col-xs-2">${users.name || ""}</td>
            <td class="col-xs-2">${users.ficha || ""}</td>
            <td class="col-xs-2">${users.email || ""}</td>
            <td class="col-xs-2">${users.numberPhone || ""}</td>
            <td class="col-xs-2">${users.addres || ""}</td>
            <td class="col-xs-2">${users.role || ""}</td>
            <td class="col-xs-2">${users.state || ""}</td>
            <td class="col-xs-2">
